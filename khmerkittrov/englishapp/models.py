...
class English_Chapter(models.Model):
    ...
    class Meta:
        ordering = ('title', )
        verbose_name = 'English_Chapter'
        verbose_name_plural = 'English_Chapters'
    #
...
class English_Unit(models.Model):
    title = models.CharField(max_length=250)
    chapter = models.ForeignKey(English_Chapter, on_delete=models.CASCADE)
    ...
    class Meta:
    #     ordering = ('-title',)
        verbose_name = 'English_Unit'
        verbose_name_plural = 'English_Units'
