...
class Math_Chapter(models.Model):
    ...
    class Meta:
        ordering = ('title', )
        verbose_name = 'Math_Chapter'
        verbose_name_plural = 'Math_Chapters'
    #
...
class Math_Unit(models.Model):
    title = models.CharField(max_length=250)
    chapter = models.ForeignKey(Math_Chapter, on_delete=models.CASCADE)
    ...
    class Meta:
    #     ordering = ('-title',)
        verbose_name = 'Math_Unit'
        verbose_name_plural = 'Math_Units'
